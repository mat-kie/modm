 ...
 * @brief Basic Phy MII Management interface Register mapping definition.
 * @version 0.1
 * @date 2022-09-25
 *
...
struct PHYBase
{
	static constexpr uint32_t resetTimeout{500};  ///< maximum reset time in miliseconds (IEEE802.3-22.2.4.1.1)
	...
	typedef Configuration<StatusRegister_t, SpeedStatus,
	...
	typedef Configuration<StatusRegister_t, DuplexStatus,
						  (Bit9 | Bit10 | Bit11 | Bit12 | Bit13 | Bit14 | Bit15)>
		DuplexStatus_t;
	/**
